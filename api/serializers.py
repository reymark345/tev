...
class ItemSerializerStatus(serializers.Serializer):
    ...
    amt_journal = serializers.DecimalField(max_digits=10, decimal_places=2, required=False)
    amt_budget = serializers.DecimalField(max_digits=10, decimal_places=2, required=False)
    check_amount = serializers.DecimalField(max_digits=10, decimal_places=2, required=False)
    check_issued_date = serializers.DateField(required=False)
