...
Faker.seed(313)
middle_name = ['N','A','A','B']
role_details = ['Admin','Incoming staff','Validating staff','Payroll staff', 'Certified staff','End user', 'Outgoing staff', 'Budget staff', 'Journal staff', 'Approval staff', 'Claimant']
...
userdb = StaffDetails(id_number ='16-11810',section ='Accounting section', position ='Computer Programmer III', sex = 'Male', address='J.P. Rizal', user_id = '1')
userdb.save()
